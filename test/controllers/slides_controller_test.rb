...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { content: @slide.content, presentation_id: @slide.presentation_id, slide_number: @slide.slide_number }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { content: @slide.content, presentation_id: @slide.presentation_id, slide_number: @slide.slide_number }
    assert_redirected_to slide_path(assigns(:slide))
  end
